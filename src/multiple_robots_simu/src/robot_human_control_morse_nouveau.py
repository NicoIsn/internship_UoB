...
if __name__ == '__main__':
    with pymorse.Morse() as simu:
        try:
            rospy.init_node('robot_human_navigation', anonymous=False) #false because we don't want 2 node in the same time
            ...
            rospy.loginfo("robot_human_navigation node terminated.")
