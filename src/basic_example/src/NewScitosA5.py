...
class newScitosa5(Robot):
    ...
    def __init__(self, with_cameras = 1):
        if with_cameras == newScitosa5.WITH_OPENNI:
            newScitosa5.VIDEOCAM_TOPIC        = '/head_xtion/rgb8'
            newScitosa5.DEPTHCAM_TOPIC        = '/head_xtion/depth/points_raw'

        # scitosA5.blend is located in the data/robots directory
        Robot.__init__(self, '/home/isnard/catkin_ws/src/basic_example/src/robots/scitos.blend')
